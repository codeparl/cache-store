 ...
 * to an underlying Laravel database cache repository.
 *
 * ---
 *
 ...
 * to the database store. This ensures consistent data representation
 * across different cache driver implementations, and allows complex
 * PHP types (arrays, objects) to be stored in the database.
 *
 ...
 */
final class DatabaseCacheDriver implements CacheDriver
{
    /**
     * Create a new DatabaseCacheDriver instance.
     *
    ...
    /**
     * Get path identifier (always returns null for database storage).
     */
    ...
    /**
     * Get the underlying DatabaseStore instance.
     */
