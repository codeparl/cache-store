 ...
 * to an underlying Laravel Redis cache repository.
 *
 * ---
 *
 ...
 * to the Redis store. Native Redis serialization is bypassed in favor
 * of CacheSerializer to ensure consistent data representation across
 * all cache driver implementations.
 *
 * When values are retrieved, they are unserialized back to their original
 * PHP types. If the key does not exist in Redis, the provided default
 * value is returned without attempting unserialization.
 *
...
{
    /**
     * Create a new RedisCacheDriver instance.
     *
     * @param Repository      $cache      The underlying Redis cache repository.
     ...
     * Native Redis serialization is bypassed in favor of CacheSerializer.
     *
     ...
     * at the storage layer. Redis native INCR command is used.
     *
     ...
     *
     * Bypasses serialization as this requires raw numeric values
     * at the storage layer. Redis native DECR command is used.
     *
